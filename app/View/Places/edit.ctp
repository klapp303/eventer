...
<h3>会場の修正</h3>
  ...
  <table class="PlaceAddForm">
    ...
    <tr>
      ...
      <td><?php echo $this->Form->input('name', array('type' => 'text', 'label' => false, 'placeholder' => '通称で問題なし', 'disabled' => 'disabled')); ?><span class="txt-alt txt-b">*</span></td>
    </tr>
    <tr>
      <td><label>収容人数</label></td>
      <td><?php echo $this->Form->input('capacity', array('type' => 'text', 'label' => false, 'placeholder' => '例）2000', 'disabled' => 'disabled')); ?>人<span class="txt-alt txt-b">*</span></td>
    </tr>
    <tr>
      <td><label>最寄り駅</label></td>
      <td><?php echo $this->Form->input('access', array('type' => 'text', 'label' => false, 'placeholder' => '例）東京', 'disabled' => 'disabled')); ?>駅<span class="txt-alt txt-b">*</span></td>
    </tr>
    <tr>
