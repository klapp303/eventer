...
<?php if (preg_match('#/artists/edit/#', $_SERVER['REQUEST_URI'])) { //編集用 ?>
  <h3>出演者タグの編集</h3>
...
<?php } ?><!-- form start -->
  ...
  <?php } ?>
    ...
    <tr>
      <td></td>
      <td><?php echo $this->Form->submit((preg_match('#/artists/edit/#', $_SERVER['REQUEST_URI']))? '変更する' : '登録する', array('div' => false, 'class' => 'submit')); ?>　　<span class="txt-alt txt-b">*</span><span class="txt-min">は必須項目</span></td>
    </tr>
