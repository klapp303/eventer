...
<h3>イベント一覧</h3>
  ...
  <table class="detail-list">
    <tr><th class="tbl-date_events">開催日<?php echo $this->Paginator->sort('date', '▼'); ?></th>
        <th>イベント名<?php echo $this->Paginator->sort('title', '▼'); ?></th>
        <th class="tbl-ico">種類<br>
                            状態</th>
        <th class="tbl-num">金額<br>
                            枚数</th>
        <th class="tbl-date_events">申込<br>開始日<?php echo $this->Paginator->sort('entry_start', '▼'); ?></th>
        <th class="tbl-date_events">入金<br>締切日<?php echo $this->Paginator->sort('payment_end', '▼'); ?></th>
        <th class="tbl-action_events">action</th></tr>
    
    <?php foreach ($event_lists AS $event_list) { ?>
    <tr><td class="tbl-date_events"><?php echo $event_list['Event']['date']; ?></td>
        ...
        <td class="tbl-date_events"><?php echo $event_list['Event']['entry_start']; ?></td>
        <td class="tbl-date_events"><?php echo $event_list['Event']['payment_end']; ?></td>
        <td class="tbl-action_events"><span class="icon-button"><?php echo $this->Html->link('詳細', '/event/'.$event_list['Event']['id'], array('target' => '_blank')); ?></span>
