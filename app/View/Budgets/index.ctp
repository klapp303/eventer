...
<h3>収支管理メニュー</h3>
  ...
  <ul class="list_budget">
    <li><span class="link-page"><?php echo $this->Html->link('⇨ 未対応の支払いを確認する', '/budgets/unfixed_payment/'); ?></span></li>
    <li><span class="link-page"><?php echo $this->Html->link('⇨ 未対応のチケット余りを確認する', '/budgets/unfixed_sales/'); ?></span></li>
